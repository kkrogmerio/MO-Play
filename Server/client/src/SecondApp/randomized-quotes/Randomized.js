    ...
    return(
        <div style={{margin:"0"}}>
               ...
               <button className="btn btn-block btn-danger" >
                ...
                <button className="btn btn-block btn-info">
                    <i className="fa fa-tumblr"/>
                        ...
                        <div className="col-sm-4">
                <button className="btn btn-block btn-dark" onClick={()=>dispatch(change())}>
            ...
            <div className={'style'+clasS.valueOf()+'-randomized'+" transition1"} style={{zIndex:"6"}}>
                <img src={image} alt="loading..." style={{height:"60px",width:"60px",position:"relative",top:"calc(50% - 30px)"}} className={"transition2"}/>
