  ...
  return (
    <div>
        ...
        <nav className="navbar navbar-light bg-light flex-container" style={{opacity:"0.8"}}>
            ...
            <span className="navbar-brand mb-0 h1"><h1 style={{position:"relative",marginBottom:"0px",fontSize:"50px",fontWeight:"900",fontFamily:"Verdana"}}><strong>MoPlay</strong></h1></span>
